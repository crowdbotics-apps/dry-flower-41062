"""
Django settings for dry_flower_41062 project.
...
ROOT_URLCONF = 'dry_flower_41062.urls'
...
WSGI_APPLICATION = 'dry_flower_41062.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_flower_41062 API",
    "DESCRIPTION": "API documentation for dry_flower_41062 App",
    "VERSION": "v1",
}
